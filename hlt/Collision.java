...
public class Collision {
     ...
     */
    public static boolean segmentCircleIntersect(final Position start, final Position end, final Entity circle, final double fudge, final boolean checkPastEnds) {
